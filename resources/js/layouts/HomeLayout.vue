    ...
    <div>
        ...
        >
            <div class="hidden md:block">
                <p class="text-brand-blue text-md md:text-lg">
                    The Future of Boundary Services Starts Here. Manage, Drive,
                    and Ride. All in One System.
                </p>
            </div>

            <div class="flex w-full gap-3 md:w-auto">
                <button
                    class="bg-brand-blue flex-1 rounded-md px-7 py-2 whitespace-nowrap text-white lg:px-5 xl:px-7"
                >
                    Download App
                </button>
                <button
                    class="bg-brand-green flex-1 rounded-md px-7 py-2 whitespace-nowrap text-white lg:px-5 xl:px-7"
                >
                    Login
                </button>
            </div>
        ...
        <div>
            <header
                :class="[
                    'text-brand-blue shadow-brand-shadow fixed left-1/2 z-50 flex w-[calc(100%-40px)] max-w-[1320px] -translate-x-1/2 transform items-center justify-between rounded-md bg-white px-4 py-2 text-[11px] transition-all duration-300 xl:text-[16px]',
                    isScrolled ? 'top-4' : 'top-22 md:top-32 lg:top-22',
                ]"
            >
                <!-- Logo -->
                <div>
                    <button class="border-brand-blue border-2 px-4">
                        Logo
                    </button>
                </div>
                ...
                <button
                    class="border-brand-blue text-brand-blue rounded border p-2 focus:outline-none lg:hidden"
