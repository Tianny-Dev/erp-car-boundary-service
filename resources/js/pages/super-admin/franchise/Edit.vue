...
const { props } = usePage<EditFranchiseProps>();
  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    ...
    <div class="mx-6 mb-6 max-w-full rounded-xl border p-6 shadow-sm">
      <form @submit.prevent="submit" class="space-y-8">
        ...
        <!-- Address -->
        <div class="space-y-4">
          <h2 class="text-xl font-bold text-slate-500">Franchise Address</h2>
          <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
            <div class="space-y-2">
              <Label>Region</Label>
        ...
        <div class="space-y-4">
          <h2 class="text-xl font-bold text-slate-500">Supporting Documents</h2>
          <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
            <div class="space-y-2">
            ...
            <div class="space-y-2">
              ...
              <a
                :href="props.franchise.mayor_url"
                target="_blank"
                class="ms-2 cursor-pointer text-sm text-blue-600 underline hover:text-blue-800"
              >
                View Current Mayor Permit
              </a>
            </div>
            <div class="space-y-2">
              ...
              <a
                :href="props.franchise.proof_url"
                target="_blank"
                class="ms-2 cursor-pointer text-sm text-blue-600 underline hover:text-blue-800"
              >
                View Current Proof of Capital
              </a>
            </div>
          </div>
        </div>
