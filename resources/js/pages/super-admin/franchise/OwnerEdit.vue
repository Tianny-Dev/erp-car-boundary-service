...
const { props } = usePage<OwnerDetailsProps>();
...
const submit = () => {
  ...
  if (selectedFiles.value.front_valid_id_picture) {
    data.append(
      ...
      selectedFiles.value.front_valid_id_picture,
    );
  }
  if (selectedFiles.value.back_valid_id_picture) {
    data.append(
      'back_valid_id_picture',
      selectedFiles.value.back_valid_id_picture,
    );
  }
  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="max-w-full px-6 py-3">
      <h2 class="font-mono text-2xl font-bold">
        ...
        <span
          v-if="props.franchises && props.franchises.length > 0"
          class="mt-1 block text-base font-normal text-gray-600"
        >
    ...
    <div class="mx-6 mb-6 max-w-full rounded-xl border p-6 shadow-sm">
      <form @submit.prevent="submit" class="space-y-8">
        <!-- User Information -->
        <div class="space-y-4">
          <h2 class="text-xl font-bold text-slate-500">User Information</h2>
        ...
        <!-- Address -->
        <div class="space-y-4">
          <h2 class="text-xl font-bold text-slate-500">Address</h2>
          <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
            <div class="space-y-2">
              <Label>Region</Label>
        ...
        <div class="space-y-4">
          <h2 class="text-xl font-bold text-slate-500">Valid ID Information</h2>
          <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
            <div class="space-y-2">
              <Label>ID Type</Label>
