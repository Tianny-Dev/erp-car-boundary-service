...
const breadcrumbs: BreadcrumbItem[] = [
  {
    ...
    href: owner.gpsTracker.index().url,
  },
];
  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    ...
    >
      ...
      >
        ...
        >
          <h2 class="font-mono text-xl font-semibold">GPS Monitoring</h2>

          <div
            class="flex w-full flex-col gap-3 sm:w-auto sm:flex-row sm:gap-4"
          >
            <MultiSelect
              class="w-full sm:w-auto sm:max-w-[300px] sm:min-w-[200px] sm:flex-1"
