        ...
        <div class="col-span-12 lg:col-span-7">
          <div class="relative">
            ...
            <div class="owl-carousel owl-1">
              <div class="rounded-xl border-4 border-brand-blue p-5">
                <div
                ...
                <p class="pt-4 text-lg/[22px]">
                  Safe at maayos yung biyahe ko gamit ang e-taxi nila. Real-time
                  ko nakikita kung nasaan yung driver at magkano ang pamasahe
                  bago pa ako sumakay. Madali rin magbayad gamit and GCash!
                  Sobrang convenient lalo na pag rush hour.
                </p>
              </div>
