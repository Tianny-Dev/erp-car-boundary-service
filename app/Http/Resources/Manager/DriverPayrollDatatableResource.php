...
class DriverPayrollDatatableResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        ...
        if (isset($this->amount) && !isset($this->total_amount)) {
            return [
                ...
                // CHANGED: Use 'branch' instead of 'franchise'
                'branch_name' => $this->whenLoaded('branch', fn () => $this->branch?->name),
                'driver_username' => $this->whenLoaded('driver', fn () => $this->driverDetails?->name),
                'total_deduction' => 0.00, // Explicitly set to 0 or calculate if needed for individual transactions
            ];
        }
        ...
        $data = [
            ...
            'driver_id' => $this->driver_id,
            'service_type' => $this->service_type,
            // CHANGED: Use 'branch_name' instead of 'franchise_name'
            'branch_name' => $this->branch_name ?? null,
            'payment_date' => 'N/A', // Default
            'driver_username' => $this->driver_username ?? null,

            // --- NEW: Expose the aggregated deduction value for the frontend's single 'Deduction' column ---
        ...
        // You had this block commented out. I am leaving it commented out as per your original file.
